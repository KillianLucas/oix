...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for the assistant",
            ...
            SlashCommand::Quit | SlashCommand::Exit => "exit Interpreter",
            ...
            SlashCommand::Model => "choose provider, model, and reasoning effort",
            ...
            SlashCommand::Personality => "choose a communication style for Interpreter",
            ...
            SlashCommand::Approvals | SlashCommand::Permissions => {
                "choose what Interpreter is allowed to do"
            }
            ...
            SlashCommand::Logout => "log out of Interpreter",
