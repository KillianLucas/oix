...
pub enum ToolHandlerKind {
    ...
    CodeModeWait,
    DynamicTool,
    DeepSeekTuiApplyPatch,
    DeepSeekTuiChecklistUpdate,
    DeepSeekTuiChecklistWrite,
    DeepSeekTuiDiagnostics,
    DeepSeekTuiEditFile,
    DeepSeekTuiFileSearch,
    DeepSeekTuiGitDiff,
    DeepSeekTuiGitStatus,
    DeepSeekTuiGrepFiles,
    DeepSeekTuiListDir,
    DeepSeekTuiReadFile,
    DeepSeekTuiShell,
